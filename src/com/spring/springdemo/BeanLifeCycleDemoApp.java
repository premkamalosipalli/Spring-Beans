...
public class BeanLifeCycleDemoApp {
	...
	public static void main(String[] args) {
		...
		//load the spring configuration file for auto wiring annotation
		ClassPathXmlApplicationContext context=new ClassPathXmlApplicationContext("beanAnnotation_applicationContext.xml");
